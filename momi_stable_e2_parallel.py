...
def run_sim(simrep):
	#define model
	model_stab = momi.DemographicModel(N_e=NeConstant, gen_time=gt,
								  muts_per_gen=4.5e-8)
	...
	model_inf_constant_temporal =  momi.DemographicModel(N_e=NeConstant, gen_time=1, muts_per_gen=4.5e-8)
	...
	model_inf_change_temporal =  momi.DemographicModel(N_e=NeConstant, gen_time=1, muts_per_gen=4.5e-8)
